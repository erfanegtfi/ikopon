...
class DialogFragmentDataBinding<out T : ViewDataBinding>(
    ...
    override operator fun getValue(thisRef: DialogFragment, property: KProperty<*>): T {
    ...
    private fun createBinding(fragment: DialogFragment): T {
